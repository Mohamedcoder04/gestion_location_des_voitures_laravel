    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header bg-gradient-danger d-flex align-items-center">
          <h3 class="card-title flex-grow-1"><i class="fa fa-list fa-2x"></i> Liste des Types des voitures</h3>

          <div class="card-tools d-flex align-items-center ">
          <a class="btn btn-link text-white mr-4 d-block" wire:click.prevent="toggleShowAddTypeVoitureForm"><i class="fas fa-user-plus"></i> Nouveau type</a>
